...
MTCNN::MTCNN(const string &model_path) {
	...
	Pnet.opt.num_threads = 4;
	Pnet.opt.use_winograd_convolution = true;
    Pnet.opt.use_sgemm_convolution = true;
    Pnet.opt.use_fp16_packed = true;
    Pnet.opt.use_fp16_storage = true;
    Pnet.opt.use_fp16_arithmetic = true;
    Pnet.opt.use_packing_layout = true;
    Pnet.opt.use_shader_pack8 = true;
    Pnet.opt.use_image_storage = true;

    Pnet.load_param(param_files[0].data());
    Pnet.load_model(bin_files[0].data());

	Rnet.opt.num_threads = 4;
	Rnet.opt.use_winograd_convolution = true;
    Rnet.opt.use_sgemm_convolution = true;
    Rnet.opt.use_fp16_packed = true;
    Rnet.opt.use_fp16_storage = true;
    Rnet.opt.use_fp16_arithmetic = true;
    Rnet.opt.use_packing_layout = true;
    Rnet.opt.use_shader_pack8 = true;
    Rnet.opt.use_image_storage = true;

    Rnet.load_param(param_files[1].data());
    Rnet.load_model(bin_files[1].data());

	Onet.opt.num_threads = 4;
	Onet.opt.use_winograd_convolution = true;
    Onet.opt.use_sgemm_convolution = true;
    Onet.opt.use_fp16_packed = true;
    Onet.opt.use_fp16_storage = true;
    Onet.opt.use_fp16_arithmetic = true;
    Onet.opt.use_packing_layout = true;
    Onet.opt.use_shader_pack8 = true;
    Onet.opt.use_image_storage = true;
