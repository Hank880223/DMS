...
## Cross compile ncnn with i.MX8M Plus / i.MX8 QuadMax for aarch64
    ...
    $ . /opt/bsp-5.4.70-2.3.3/environment-setup-aarch64-poky-linux You can refer to it from here [BSP](https://github.com/Hank880223/ncnn-sort-vehicle/blob/main/doc/BSP.md "link")
    $ cmake ..
